...
DATABASES = {
    'default': {
        ...
        'NAME': 'notejam',
        'USER': os.environ.get('NJ_DB_USER', 'ognotes'),
        'PASSWORD': os.environ.get('NJ_DB_PASSWORD', 'password'),
        'HOST': os.environ.get('NJ_DB_HOST', 'localhost'),
        'PORT': os.environ.get('NJ_DB_PORT', 3306)
    }
}
